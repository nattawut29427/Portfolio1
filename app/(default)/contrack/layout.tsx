    ...
    <>
      <div className="bg-[#0E1111] font-body w-screen h-screen relative overflow-hidden">
        ...
        <p className="w-screen h-screen bg-black opacity-80 absolute "></p>
          <div className="blur-[180px] w-[300px] sm:w-[500px] lg:w-[630px] m h-[300px] mb-[750px] overflow-hidden sm:h-[500px] lg:h-[630px] rounded-full bg-gradient-to-t from-[#00D0FF] to-[#FF007B] shadow-2xl"></div>
        </div>
